        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            var alertBox =
              '<div class="alert ' +
              messageAlert +
              ' alert-dismissible fade show"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>' +
              messageText +
              "</div>";
...
$(function () {
 ...
 function sameHeight(i, e) {

   var elementHeight = $("." + i).outerHeight();

   $("." + e).css("height", elementHeight);
 }
